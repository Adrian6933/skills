...
description: Reviews animation and motion code against a high craft bar derived from Emil Kowalski's design engineering philosophy. Default to flagging; approval is earned. Use when the user adds or changes CSS/JS animations, transitions, or motion code and wants it reviewed for craft.
---
