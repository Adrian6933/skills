---
name: error-handling
description: Patterns for robust error handling across TypeScript, Python, and Go. Covers typed errors, error boundaries, retries, circuit breakers, and user-facing error messages. Use when writing or reviewing error handling, try/catch logic, retries, or user-facing error messages.
metadata:
  origin: ECC
---
