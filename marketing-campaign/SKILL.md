...
description: End-to-end marketing campaign planning and execution. Covers audience research, positioning, campaign angle definition, landing page copy, email sequences, social posts, ad copy, short-form video scripts, and content calendars. Use when the user wants to plan or launch a multi-channel campaign (e.g. launching a new affiliate store), not just one asset.
metadata:
  origin: ECC
---
